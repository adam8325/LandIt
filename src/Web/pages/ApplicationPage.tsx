            ...
            <div className="bg-slate-950 p-8 min-h-screen w-full">
                <div className="w-3/4 flex flex-col items-center justify-center text-center text-white gap-10 mx-auto">
                    <div className="grid grid-cols-3 w-full">
                        <Link to="/" className="place-self-start mr-auto btn py-1 px-2 rounded-lg font-semibold text-xs flex items-center justify-center
                    ...
                    {!isCompleted ? (
                        <>
                                ...
                                <section className="w-1/2 flex flex-col bg-gradient-to-b from-gray-900 via-transparent to-gray-900 border border-cyan-950 px-4 py-2 text-center gap-2 rounded-lg">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-gray-400 text-xs sm:text-sm">Upload eller indsæt dit CV</p>
                                        </div>                            
                                    </div>                        
                                    <div>
                                        <button 
                                ...
                                <section className="w-1/2 flex flex-col bg-gradient-to-b from-gray-900 via-transparent to-gray-900 border border-cyan-900 px-4 py-2 text-center gap-2 rounded-lg">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <div className="flex items-center gap-1">
                                                <FontAwesomeIcon icon={faFileLines} className="text-blue-500 text-xs" />
                                            ...
                                            <p className="text-gray-400 text-xs sm:text-sm">Upload eller indsæt jobopslag</p>
                                        </div>                            
                                    </div>
                                    <div>
                                        <button 
                    ...
                    (
                        <div className="flex items-center justify-between gap-10 w-full h-full rounded-lg ">
                            <section className="flex flex-col items-center rounded-lg w-1/3 h-140 bg-gradient-to-b from-gray-900 via-transparent to-gray-900 border border-cyan-950 p-4">
                            ...
                            <section className="flex flex-col gap-4 rounded-lg w-2/3 h-140 bg-gradient-to-b from-gray-900 via-transparent to-gray-900 border border-cyan-900 p-4">
